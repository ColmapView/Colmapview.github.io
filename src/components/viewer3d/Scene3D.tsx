...
export function Scene3D() {
  ...
  return (
    <div className="w-full h-full relative" style={{ backgroundColor }}>
      ...
      >
        <img src="/LOGO.png" alt="Opsiclear" className="opacity-70 hover:opacity-100 transition-opacity" style={{ height: '5vh' }} />
      </a>
      <div className="absolute bottom-6 right-6 flex items-center gap-4">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-ds-secondary opacity-70 hover:opacity-100 transition-opacity"
        >
